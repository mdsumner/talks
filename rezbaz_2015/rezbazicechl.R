...
library(geosphere)
data(countriesLow)
prj <- "+proj=laea +lat_0=-90 +lon_0=145 +datum=WGS84 +units=m +no_defs +ellps=WGS84 +towgs84=0,0,0"
...
##lapply(icelines[26:35], function(x) plot(spTransform(x, CRS(prj)), add = TRUE, col = "grey"))
...
title("MODISA chlorophyll-a and recent sea ice cover 2015-02-06")
dev.off()
