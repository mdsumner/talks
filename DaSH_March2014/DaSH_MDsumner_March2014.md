...
<img src="DaSH_MDsumner_March2014-figure/unnamed-chunk-15.png" title="plot of chunk unnamed-chunk-15" alt="plot of chunk unnamed-chunk-15" style="display: block; margin: auto;" />
...
- file catalogue is clunky, need tools to build/rebuild/maintain (or replace) repository
- extend read to OpenDAP, HDF, model output, etc. 
- relation to other data portals?
- extend extract to trip/track objects, tools for merging with track-estimates
- spatial.tools for easy parallelization
- rasterVis, specialist space-time plots
- rgdal2, superior rewrite
- D3/TopoJSON, ggvis, Shiny apps
